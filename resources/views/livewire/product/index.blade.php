        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Product <button wire:click="$toggle('formVisible')" class="btn btn-sm btn-primary">Create</button>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <select wire:model="paginate" name="" id="" class="form-select form-control-sm w-auto">
